...
;
(function($, undefined) {
    $.fn.temporalDetailed = function(options) {
        var defaults = {
        ...
        var methods = {
            ...
            processColumnClicked: function(_this, isSelected, index, isSource) {
                var x = 124 + (index * opts.dimension.padding.breakupPadding);
                if (isSelected) {
                ...
                if (isSelected) {
                    if (!opts.lockInteraction) {
                        ...
                        opts.boundingRect.append("rect")
                                ...
                                .attr("x", 0)
                                .attr("y", y)
                                .attr("width", opts.dimension.chartWidth - 6)
            ...
            processItemClicked: function(_this, isSelected, datum, isSource) {
                var x = 124 + (datum.col_index * opts.dimension.padding.breakupPadding);
            ...
            renderKey: function() {
                ...
                keySVG.append("g").attr("class", "key")
            ...
            drawViz: function() {
                ...
                boundingRect.selectAll(".column-heading").data(["Morning", "Afternoon", "Evening", "Night"]).enter()
                        ...
                        .attr("x", function(datum, index) {
                            return 155 + (index * opts.dimension.padding.breakupPadding);
                        })
                            ...
                            dayBreakupG.selectAll('.dayBreakup').data(opts.data).enter()
                                    ...
                                    .each(function(datum, index) {
                                        ...
                                        dayBreakup.selectAll('.circleG').data(datum.detailed).enter()
                                                ...
                                                .attr("class", "circleG")
                                                .attr("transform", function(datum, index) {
                                                    return "translate(" + ((index * opts.dimension.padding.breakupPadding)) + ", 0)";
                                                })
                                                .on("click", function(datum, index) {
                                                    var _this = d3.select(this);
                                                    var thisClass = _this.attr("class");
